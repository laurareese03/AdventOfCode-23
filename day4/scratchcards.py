...
# part b
total_cards = 0
card_multiples = [1] * len(lines) # stores how many of each future card we have. start with 1 og, with more to be added
for line in lines:
  ...
  # for each duplicate card we have we have to add the multiples of [matching numbers (intersect)] number of future cards
  card_wins = get_set_intersects(line)
